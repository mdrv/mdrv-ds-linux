...
/// Provenance block: the real USB 289 B descriptor. Unused directly (the
/// virtual pad carries DS5_HID_REPORT_DESCRIPTOR_MERGED), kept as the source
/// the merged descriptor was spliced from.
#[allow(dead_code)]
