...
pub const DS5_HID_REPORT_DESCRIPTOR_MERGED: &[u8] = &[
    ...
    ,
...
/// Mic-state 0x31 head sent before audio starts (v28 handshake, vdsd
/// "mic-active" state: AllowMicVolume|AllowAudioControl + internal mic).
pub const MIC_STATE: [u8; 47] = {
    let mut s = [0u8; 47];
    s[0] = 0xC0; // AllowMicVolume | AllowAudioControl
    s[1] = 0x83; // AllowMuteLight | AllowAudioMute | AllowAudioControl2
    s[6] = 0x08; // mic volume
    s[7] = 0x39; // audio control: speaker path
    s[9] = 0x0F; // power-save control
...
pub fn open(poll_exit: &dyn Fn() -> bool) -> Result<Session, String> {
    ...
    for id in [0x09u8, 0x20, 0x05] {
        match Session::get_feature(&mut ctrl, id) {
            ...
            None if id == 0x09 => {
                return Err(
                    "l2cap: pad did not answer feature 0x09 — not a DualSense, closing".into(),
                );
            }
